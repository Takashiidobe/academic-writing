...
bibliography: "src/semver-trick.bib"
---

## The Semver Trick

This paraphrases the original repo here: @dtolnay2022;
...
1. Make the breaking change, bumping the semver version to one
   major/minor version + 1.
2. Update the 0.1 version to have a dependency on itself on version + 1
...
0.1 or 0.2's version. Of course, if they used uncommonly_used, they must
wait for all their dependents to upgrade, but now widely used types are
not caught in the crossfire of updates for uncommonly used types.
